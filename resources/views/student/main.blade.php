...
<section class="hero py-5">
    <div class="container">
      ...
      <button type="submit" class="btn btn-primary text-center mt-2" name="submit">Registration</button>
        <a href="index1.php" rule="button" class="btn btn-outline-primary mt-2">Cancel</a>
    </form>
        </div>
        ...
        <h2 class="mt-5 mb-3 text-center">Student Information</h2>
                <div class="card-body">
